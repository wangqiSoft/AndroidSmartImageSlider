package com.wangqiSoftdemo.smartimageslider;
...
import com.wangqiSoft.smartimageslider.Animations.DescriptionAnimation;
...
import com.wangqiSoft.smartimageslider.SliderTypes.TextSliderView;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.action_github:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/wangqiSoft/AndroidSmartImageSlider-master"));
